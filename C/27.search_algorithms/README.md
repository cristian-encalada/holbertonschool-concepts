...
Write a function that searches for a value in a sorted array of integers using the [Jump search](https://en.wikipedia.org/wiki/Jump_search) algorithm
...
__9. Interpolation search__

Write a function that searches for a value in a sorted array of integers using the [Interpolation search](https://en.wikipedia.org/wiki/Interpolation_search) algorithm
...
__10. Exponential search__

Write a function that searches for a value in a sorted array of integers using the [Exponential search](https://en.wikipedia.org/wiki/Exponential_search) algorithm
...
- You can assume that `array` will be sorted in ascending order
- If `value` is not present in arra`y or if `array` is `NULL`, your function must return `-1`
- Every time you split the array, you have to print the new array (or subarray) you’re searching in (See example)
...
__12. Jump search in a singly linked list__
...
__NOTE:__ [You can find here](https://github.com/hs-hq/0x1D.c/tree/main/listint) the functions used in the example. You don’t need to push them, we will compile your file with our own implementation during the correction.
...
__13. Linear search in a skip list__
...
__NOTE:__ [You can find here](https://github.com/hs-hq/0x1D.c/tree/main/skiplist) the functions used in the example. You don’t need to push them, we will compile your file with our own implementation during the correction.
